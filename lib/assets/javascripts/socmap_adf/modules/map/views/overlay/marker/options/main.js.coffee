...
ADF.Map.Views.Overlay.Marker.Options ||= {}

class ADF.Map.Views.Overlay.Marker.Options.Main
  ...
  initMarkerImages: () ->
    @icon = new google.maps.MarkerImage(@iconUrl, @iconSize, @iconOrigin, @iconAnchor) if @iconUrl
